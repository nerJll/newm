...
<!-- Bootstrap Core CSS -->
<link href="${ctx}/sbadmin/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

<!-- MetisMenu CSS -->
<link href="${ctx}/sbadmin/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

<!-- Custom CSS -->
<link href="${ctx}/sbadmin/dist/css/sb-admin-2.css" rel="stylesheet">

<!-- Custom Fonts -->
<link href="${ctx}/sbadmin/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<div id="wrapper"> 
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${ctx}/sbadmin/pages/blank.html" target="_blank"></a> 
      </div>
    <!-- /.navbar-header -->
        ...
        <ul class="nav" id="side-menu">
          ...
          <li> <a href="javascript:void(0)"><i class="fa fa-bar-chart-o fa-fw"></i>菜单<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              <li> <a class="menuc" url="${ctx}/meeting/index" href="javascript:void(0)">管理会议</a> </li>
              <li> <a class="menuc" url="${ctx}/meetingRoom/index" href="javascript:void(0)">管理会议室</a> </li>
              <!-- <li> <a href="${ctx}/meetingRoom/index" target="_blank">登陆页</a> </li> -->
            </ul>
            <!-- /.nav-second-level --> 
          </li>
        </ul>
...
<iframe src="${ctx}/test/index2" marginheight="0" marginwidth="0" frameborder="0"
 scrolling="no" width="100%" height="100%" id="iframecon" name="iframepage" onLoad="iFrameHeight();" ></iframe>
...
<!-- jQuery --> 
<script src="${ctx}/sbadmin/bower_components/jquery/dist/jquery.min.js"></script> 

<!-- Bootstrap Core JavaScript --> 
<script src="${ctx}/sbadmin/bower_components/bootstrap/dist/js/bootstrap.min.js"></script> 

<!-- Metis Menu Plugin JavaScript --> 
<script src="${ctx}/sbadmin/bower_components/metisMenu/dist/metisMenu.min.js"></script> 

<!-- Custom Theme JavaScript --> 
<script src="${ctx}/sbadmin/dist/js/sb-admin-2.js"></script>
